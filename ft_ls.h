...
void					get_files(int start, int i, char **str, t_request *t);
void					get_directory_contents(t_node *dir, t_request *t);
...
t_invalid				*comp_and_swap_err_files(t_invalid *f, t_request *t);
t_node					*swap_request_files(t_node *a, t_node *b, t_request *t);
t_node					*swap_dir_files(t_node *n1, t_node *n2, t_node *dir);
...
void					print_r_dir_name(t_node *dir, t_request *this, int i);
void					print_r_directories(t_request *this);
void					print_recursive(t_node *dir, t_request *this, int i);
